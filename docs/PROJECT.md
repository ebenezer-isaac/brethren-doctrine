...
- Source documents → structured JSON via Opus subagent orchestration.
...
- Chunks from `parsed/` + full Bible (multiple translations) + Hebrew/Greek interlinear + archaeology + church history.
