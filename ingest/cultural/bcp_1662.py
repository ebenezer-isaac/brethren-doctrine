"""Book of Common Prayer 1662 adapter (Pipeline 1 cultural, stub).
...
REDISTRIBUTE = True
CANONICAL_URL = "https://justus.anglican.org/resources/bcp/1662/"
FALLBACK_URLS: list[str] = ["https://en.wikisource.org/wiki/Book_of_Common_Prayer_(1662)"]
EXPECTED = (150, 250)
