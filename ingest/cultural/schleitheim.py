"""Schleitheim Confession adapter (Pipeline 1 cultural, stub).
...
REDISTRIBUTE = True
CANONICAL_URL = "https://en.wikisource.org/wiki/Schleitheim_Confession"
FALLBACK_URLS: list[str] = ["https://anabaptists.org/history/the-schleitheim-confession.html"]
EXPECTED = (7, 7)
